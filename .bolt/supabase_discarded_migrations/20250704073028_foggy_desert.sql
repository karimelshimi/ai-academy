...
INSERT INTO profiles (id, email, full_name, role) VALUES
  ('00000000-0000-0000-0000-000000000001', 'admin@ai-academy.com', 'حسام أحمد', 'admin')
ON CONFLICT (id) DO NOTHING;

-- Insert sample courses
INSERT INTO courses (id, title, description, price, category, level, duration_hours, is_published, instructor_id) VALUES
  (
