/*
  ...
  Note: We cannot insert into profiles table directly as it requires auth.users entries.
  Instead, we'll insert sample courses and lessons that can be used once users register.
*/
